class Funder < ApplicationRecord
  ...
  validates :name, presence: true, length: {maximum: 255}, uniqueness: {:scope => :email, case_sensitive: false}
  ...
  validates :description, length: {maximum: 65536}, allow_blank: true
end
