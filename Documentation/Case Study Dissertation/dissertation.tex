...
The initial page is very basic, not very colourful and errors containing. It was created to point out the idea of the  design and to outline a vision of how the site would work. The team decided to add the colours and the feel of the blog that the program already had.

\subsection{Final Prototype}
\label{sec:prototype2} 

Our second design was more simplified in terms of account organisation. The customers clarified that the members would not be able to sign up, which led to deleting this feature. Furthermore, we merged the home page with the login page, so that we can have a simple enough view. The new prototype can be found in Figure 4.
...
An important point to note is that Bootstrap only officially supports Internet Explorer 8-11.
